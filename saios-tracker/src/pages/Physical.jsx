...
const fields = [
  { name: 'workout', label: 'Workout Type', type: 'select', options: ['Cardio', 'Strength', 'Yoga', 'Running', 'Walking', 'Other'] },
...
export default function Physical() {
  return (
    <EnhancedDomainTracker title="Physical Health" fields={fields} storageKey="physical" chartConfig={chartConfig} />
  );
}